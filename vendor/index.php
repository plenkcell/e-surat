...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-mini"><b>RSI</b></span>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <?php
                  ...
                  $sql_u = $koneksi->query("select* from rsi_user where nip='$user_l' and is_aktif='1'");
        ...
        ?>
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo $data_u['nm_pegawai']; ?></span>
            </a>
  ...
  <footer class="main-footer style=background-color: rgba(0, 0, 0, 0.05);">
    ...
    <strong>Copyright &copy; 2024 SISTEM SURAT ELEKTRONIK - IPDE - RSIFC</a>.</strong> Salam Care
  </footer>
